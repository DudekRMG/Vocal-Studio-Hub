  ...
  return (
    <>
      ...
      <section className="min-h-[70vh] flex flex-col justify-end px-6 lg:px-12 pt-36 pb-20 bg-[#080808] relative overflow-hidden border-b border-white/[0.08]">
        ...
        <div className="absolute top-1/2 -left-6 -translate-y-1/2 -rotate-90 font-['Bebas_Neue'] text-[22vw] text-[rgba(232,0,45,0.04)] pointer-events-none whitespace-nowrap leading-none" style={{ transformOrigin: "left center" }}>
          EXTREME
        </div>
        <div className="max-w-[1100px] mx-auto w-full">
          <span className="text-[0.68rem] tracking-[0.28em] uppercase text-[#e8002d] block mb-5">{c.heroTag}</span>
          <h1 className="font-['Bebas_Neue'] text-[clamp(4rem,10vw,9rem)] leading-[0.85] tracking-[0.02em] mb-6">{c.heroTitle}</h1>
          ...
          <a
            href="#book-extreme"
            className="inline-flex items-center gap-3 bg-[#e8002d] text-[#f0eeea] font-['Bebas_Neue'] text-[1.1rem] tracking-[0.15em] px-10 py-5 no-underline transition-all duration-200 hover:bg-[#ff1a3d] group"
          >
      ...
      <section className="py-28 px-6 lg:px-12 bg-[#0f0f0f] border-b border-white/[0.08]">
        <div className="max-w-[1100px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <h2 className="font-['Bebas_Neue'] text-[clamp(2.5rem,4vw,4rem)] leading-[0.95] tracking-[0.02em] mb-8">{c.whatTitle}</h2>
      ...
      <section className="py-28 px-6 lg:px-12 bg-[#080808] border-b border-white/[0.08]">
        <div className="max-w-[1100px] mx-auto">
          <h2 className="font-['Bebas_Neue'] text-[clamp(2.5rem,4vw,4rem)] leading-[0.95] tracking-[0.02em] mb-16">{c.techniquesTitle}</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[1px] bg-white/[0.08]">
            {c.techniques.map((tech, i) => (
              <div key={tech.name} className="bg-[#080808] p-10 relative group hover:bg-[#0d0a0a] transition-colors duration-300">
                <span className="font-['Bebas_Neue'] text-[5rem] leading-none text-[rgba(232,0,45,0.06)] absolute top-4 right-6">{String(i + 1).padStart(2, "0")}</span>
                <h3 className="font-['Bebas_Neue'] text-[1.8rem] tracking-[0.05em] mb-4 text-[#e8002d]">{tech.name}</h3>
      ...
      <section className="py-28 px-6 lg:px-12 bg-[#141414] border-b border-white/[0.08]">
        <div className="max-w-[1100px] mx-auto">
          <h2 className="font-['Bebas_Neue'] text-[clamp(2.5rem,4vw,4rem)] leading-[0.95] tracking-[0.02em] mb-16">{c.processTitle}</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[1px] bg-white/[0.08]">
            {c.processSteps.map((step) => (
              <div key={step.num} className="bg-[#141414] p-10">
                <div className="font-['Bebas_Neue'] text-[3.5rem] leading-none text-[rgba(232,0,45,0.2)] mb-6">{step.num}</div>
      ...
      <section className="py-28 px-6 lg:px-12 bg-[#0f0f0f] border-b border-white/[0.08]">
        <div className="max-w-[800px] mx-auto">
          <h2 className="font-['Bebas_Neue'] text-[clamp(2.5rem,4vw,4rem)] leading-[0.95] tracking-[0.02em] mb-16">{c.faqTitle}</h2>
          <div className="flex flex-col gap-[1px] bg-white/[0.08]">
            {c.faqs.map((faq) => (
              <div key={faq.q} className="bg-[#0f0f0f] px-10 py-8">
                <h3 className="font-['Bebas_Neue'] text-[1.15rem] tracking-[0.05em] text-[#f0eeea] mb-3">{faq.q}</h3>
      ...
      <section className="py-20 px-6 lg:px-12 bg-[#e8002d] relative overflow-hidden">
        <div className="max-w-[1100px] mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            <h2 className="font-['Bebas_Neue'] text-[clamp(2rem,4vw,3.5rem)] leading-[0.95] text-[#f0eeea]">{c.ctaBanner}</h2>
            <p className="text-[0.9rem] text-[rgba(240,238,234,0.75)] mt-3">{c.ctaBannerSub}</p>
          </div>
          <a href="#book-extreme" className="flex-shrink-0 bg-[#f0eeea] text-[#080808] font-['Bebas_Neue'] text-[1.1rem] tracking-[0.15em] px-10 py-5 no-underline hover:bg-white whitespace-nowrap inline-flex items-center gap-3 group transition-colors duration-200">
            {c.ctaBtn}
            <svg className="transition-transform duration-200 group-hover:translate-x-1" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M5 12h14M12 5l7 7-7 7" /></svg>
          </a>
        </div>
