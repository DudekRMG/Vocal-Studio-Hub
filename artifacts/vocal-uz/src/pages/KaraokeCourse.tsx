        ...
        <div className="max-w-[1100px] mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-col items-center gap-3 flex-shrink-0">
            <VoiceRangeWidget
              accentColor={gold}
              pageName={c.heroTag}
              triggerBorder="rgba(0,0,0,0.3)"
              triggerColor="rgba(0,0,0,0.7)"
              triggerHoverBorder="rgba(0,0,0,0.6)"
              triggerHoverColor="#080808"
            />
            <a
              href="#book-karaoke"
              onClick={(e) => {
              ...
              className="bg-[#080808] text-[#f0eeea] font-display text-[1.1rem] tracking-[0.15em] px-10 py-5 no-underline transition-colors duration-200 hover:bg-[#1a1a1a] whitespace-nowrap inline-flex items-center gap-3 group"
            >
              {c.ctaBtn}
      ...
      <section id="book-karaoke" className="bg-[#141414] border-t border-white/[0.08]">
        ...
        <div className="px-6 lg:px-12 pt-10 pb-4 border-b border-white/[0.05]">
          <div className="max-w-[1100px] mx-auto flex flex-col sm:flex-row items-center sm:items-center gap-4">
            ...
            <VoiceRangeWidget accentColor={gold} pageName={c.heroTag} />
          </div>
        </div>
        ...
        <div className="border-t border-white/[0.06] pt-12 pb-6 px-6 lg:px-12">
          <div className="max-w-[1100px] mx-auto mb-6">
            <span className="text-[0.62rem] tracking-[0.28em] uppercase block mb-3" style={{ color: gold }}>{t[lang].booking.moreOptions}</span>
