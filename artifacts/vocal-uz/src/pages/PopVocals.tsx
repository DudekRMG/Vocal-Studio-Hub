...
export default function PopVocals() {
  ...
  return (
    <>
      ...
      {/* ── HERO ── */}
      <section className="min-h-[70vh] flex flex-col justify-end px-6 lg:px-12 pt-36 pb-20 bg-[#0f0f0f] relative overflow-hidden border-b border-white/[0.08]">
        <div className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse 70% 60% at 80% 40%, rgba(240,238,234,.04) 0%, transparent 70%)" }} />
        <div
          className="absolute top-1/2 -right-6 rotate-90 font-['Playfair_Display'] italic text-[22vw] text-[rgba(240,238,234,0.025)] pointer-events-none whitespace-nowrap leading-none"
          style={{ transformOrigin: "right center" }}
        >
          Pop
        </div>
        <div className="max-w-[1100px] mx-auto w-full">
          <span className="text-[0.68rem] tracking-[0.28em] uppercase text-[#555] block mb-5">{hero.tag}</span>
          <h1 className="font-['Playfair_Display'] italic text-[clamp(4rem,9vw,8rem)] leading-[0.9] mb-6">
            {hero.title}
