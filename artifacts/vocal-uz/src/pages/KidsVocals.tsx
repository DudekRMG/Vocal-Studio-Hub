...
const bgAlt    = "#e4ecf6";
const bgCard   = "#f4f8fd";
const cardBorder = "#c8d8ea";
const textPrimary = "#111827";
const textBody    = "#4a5e72";
const textMuted   = "#5a7898";
const textItem    = "#2a3a50";
const textDivider = "#dde3ee";
  ...
  return (
    <>
      ...
      <section
        ...
        style={{ backgroundColor: bgHero, borderColor: textDivider }}
      >
        <div className="absolute inset-0 pointer-events-none" style={{ background: `radial-gradient(ellipse 70% 60% at 20% 60%, rgba(61,111,212,0.07) 0%, transparent 70%)` }} />
        <div
          className="absolute bottom-[-20px] right-[-10px] font-display pointer-events-none whitespace-nowrap leading-none select-none"
          style={{ color: "#c8d8ea", fontSize: "clamp(8rem,20vw,22rem)" }}
        >
          KIDS
        </div>
        <div className="max-w-[1100px] mx-auto w-full">
          <span className="text-[0.68rem] tracking-[0.28em] uppercase block mb-5" style={{ color: textMuted }}>{c.heroTag}</span>
          <h1 className="font-display text-[clamp(4rem,10vw,9rem)] leading-[0.85] tracking-[0.02em] mb-6" style={{ color: textPrimary }}>{c.heroTitle}</h1>
          <p className="font-['Playfair_Display'] italic text-[clamp(1.2rem,2.5vw,1.8rem)] mb-8 max-w-[500px]" style={{ color: textMuted }}>{c.heroSub}</p>
          <p className="text-[0.9rem] leading-[1.9] max-w-[520px] mb-10" style={{ color: textBody }}>{c.heroDesc}</p>
          <a
            href="#book-kids"
      ...
      {/* ── ABOUT THE APPROACH ── */}
      <section className="py-28 px-6 lg:px-12 border-b" style={{ backgroundColor: bgBase, borderColor: textDivider }}>
        <div className="max-w-[1100px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-start">
          <div>
            <span className="text-[0.68rem] tracking-[0.28em] uppercase block mb-4" style={{ color: textMuted }}>
              {lang === "ru" ? "О подходе" : "The Approach"}
            </span>
            <h2 className="font-display text-[clamp(2.5rem,4vw,4rem)] leading-[0.95] tracking-[0.02em] mb-8" style={{ color: textPrimary }}>{c.aboutTitle}</h2>
            <div className="w-10 h-[2px] mb-8" style={{ backgroundColor: blue }} />
            <p className="text-[0.9rem] leading-[1.9] mb-5" style={{ color: textBody }}>{c.aboutBody1}</p>
            <p className="text-[0.9rem] leading-[1.9]" style={{ color: textBody }}>{c.aboutBody2}</p>
          </div>
          <div className="grid grid-cols-2 gap-[1px]" style={{ backgroundColor: cardBorder }}>
            {c.aboutFeatures.map((item) => (
              <div key={item} className="p-6 flex items-center" style={{ backgroundColor: bgCard }}>
                <span className="w-3 h-[1px] mr-4 flex-shrink-0" style={{ backgroundColor: blue }} />
                <span className="text-[0.82rem]" style={{ color: textItem }}>{item}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ── AGE GROUPS ── */}
      <section className="py-28 px-6 lg:px-12 border-b" style={{ backgroundColor: bgAlt, borderColor: textDivider }}>
        <div className="max-w-[1100px] mx-auto">
          <h2 className="font-display text-[clamp(2.5rem,4vw,4rem)] leading-[0.95] tracking-[0.02em] mb-16" style={{ color: textPrimary }}>{c.ageGroupsTitle}</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-[1px]" style={{ backgroundColor: cardBorder }}>
            {c.ageGroups.map((group, i) => (
              <div key={group.range} className="p-10 relative" style={{ backgroundColor: bgCard, border: `1px solid ${cardBorder}` }}>
                <div className="font-display text-[4rem] leading-none absolute top-4 right-6 pointer-events-none" style={{ color: `rgba(61,111,212,0.15)` }}>
                  {String(i + 1).padStart(2, "0")}
                </div>
                <div className="font-display text-[0.8rem] tracking-[0.2em] mb-2" style={{ color: textMuted }}>{group.range}</div>
                <h3 className="font-display text-[1.8rem] tracking-[0.05em] mb-4" style={{ color: textPrimary }}>{group.label}</h3>
                <p className="text-[0.85rem] leading-[1.8] mb-6" style={{ color: textBody }}>{group.desc}</p>
                <ul className="list-none m-0 p-0 flex flex-col gap-2">
                  {group.points.map((pt) => (
                    <li key={pt} className="text-[0.78rem] flex items-center gap-3" style={{ color: textItem }}>
      ...
      <section className="py-28 px-6 lg:px-12 border-b" style={{ backgroundColor: bgBase, borderColor: textDivider }}>
        <div className="max-w-[1100px] mx-auto">
          <h2 className="font-display text-[clamp(2.5rem,4vw,4rem)] leading-[0.95] tracking-[0.02em] mb-4" style={{ color: textPrimary }}>{c.stylesTitle}</h2>
          <p className="text-[0.9rem] leading-[1.9] mb-14 max-w-[560px]" style={{ color: textMuted }}>{c.stylesSub}</p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[1px]" style={{ backgroundColor: cardBorder }}>
            {c.styles.map((style, i) => (
              <div key={style.name} className="p-10 relative" style={{ backgroundColor: bgCard, border: `1px solid ${cardBorder}` }}>
                <span className="font-display text-[5rem] leading-none absolute top-4 right-6 pointer-events-none" style={{ color: `rgba(61,111,212,0.10)` }}>
                  {String(i + 1).padStart(2, "0")}
                </span>
                <h3 className="font-display text-[1.5rem] tracking-[0.05em] mb-4" style={{ color: textPrimary }}>{style.name}</h3>
                <p className="text-[0.85rem] leading-[1.8]" style={{ color: textBody }}>{style.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-28 px-6 lg:px-12 border-b" style={{ backgroundColor: bgAlt, borderColor: textDivider }}>
        <div className="max-w-[1100px] mx-auto">
          <h2 className="font-display text-[clamp(2.5rem,4vw,4rem)] leading-[0.95] tracking-[0.02em] mb-16" style={{ color: textPrimary }}>{c.processTitle}</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[1px]" style={{ backgroundColor: cardBorder }}>
            {c.processSteps.map((step) => (
              <div key={step.num} className="p-10" style={{ backgroundColor: bgCard, border: `1px solid ${cardBorder}` }}>
                <div className="font-display text-[3.5rem] leading-none mb-6" style={{ color: `rgba(61,111,212,0.30)` }}>{step.num}</div>
                <h3 className="font-display text-[1.15rem] tracking-[0.08em] mb-4" style={{ color: textPrimary }}>{step.title}</h3>
                <p className="text-[0.82rem] leading-[1.8]" style={{ color: textBody }}>{step.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-28 px-6 lg:px-12 border-b" style={{ backgroundColor: bgBase, borderColor: textDivider }}>
        <div className="max-w-[1100px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-start">
          <div>
            ...
            <h2 className="font-display text-[clamp(2.5rem,4vw,4rem)] leading-[0.95] tracking-[0.02em] mb-8" style={{ color: textPrimary }}>{c.safetyTitle}</h2>
            <div className="w-10 h-[2px] mb-8" style={{ backgroundColor: blue }} />
            <p className="text-[0.9rem] leading-[1.9] mb-5" style={{ color: textBody }}>{c.safetyBody1}</p>
            <p className="text-[0.9rem] leading-[1.9]" style={{ color: textBody }}>{c.safetyBody2}</p>
          </div>
          <div className="flex flex-col gap-[1px]" style={{ backgroundColor: cardBorder }}>
            {c.safetyPoints.map((point) => (
              <div key={point} className="flex items-start gap-5 p-7" style={{ backgroundColor: bgCard, border: `1px solid ${cardBorder}` }}>
                <div className="w-5 h-5 flex-shrink-0 flex items-center justify-center mt-[2px]" style={{ border: `1.5px solid ${blue}` }}>
                  <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke={blue} strokeWidth="2.5"><polyline points="20 6 9 17 4 12" /></svg>
                </div>
                <p className="text-[0.88rem] leading-[1.7]" style={{ color: textItem }}>{point}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-28 px-6 lg:px-12 border-b" style={{ backgroundColor: bgAlt, borderColor: textDivider }}>
        <div className="max-w-[800px] mx-auto">
          <h2 className="font-display text-[clamp(2.5rem,4vw,4rem)] leading-[0.95] tracking-[0.02em] mb-16" style={{ color: textPrimary }}>{c.faqTitle}</h2>
          <div className="flex flex-col" style={{ borderTop: `1px solid ${cardBorder}` }}>
            {c.faqs.map((faq) => (
              <div key={faq.q} className="px-0 py-8" style={{ borderBottom: `1px solid ${cardBorder}` }}>
                <h3 className="font-display text-[1.15rem] tracking-[0.05em] mb-3 font-bold" style={{ color: textPrimary }}>{faq.q}</h3>
                <p className="text-[0.88rem] leading-[1.8]" style={{ color: textBody }}>{faq.a}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ── CTA BANNER ── */}
      <section className="py-20 px-6 lg:px-12 relative overflow-hidden" style={{ backgroundColor: "#1e2d4a" }}>
        ...
        <div className="max-w-[1100px] mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            <h2 className="font-display text-[clamp(2rem,4vw,3.5rem)] leading-[0.95]" style={{ color: "#eef2f8" }}>{c.ctaBanner}</h2>
            <p className="text-[0.9rem] mt-3" style={{ color: "#7a90aa" }}>{c.ctaBannerSub}</p>
          </div>
          <a
            href="#book-kids"
            className="flex-shrink-0 font-display text-[1.1rem] tracking-[0.15em] px-10 py-5 no-underline transition-all duration-200 whitespace-nowrap inline-flex items-center gap-3 group"
            style={{ backgroundColor: "transparent", border: "1.5px solid #eef2f8", color: "#eef2f8" }}
            onMouseEnter={e => { e.currentTarget.style.backgroundColor = "rgba(238,242,248,0.1)"; }}
      ...
      {/* ── BOOKING ── */}
      <section id="book-kids" className="py-28 px-6 lg:px-12 border-t" style={{ backgroundColor: bgBase, borderColor: textDivider }}>
        <div className="max-w-[1100px] mx-auto grid grid-cols-1 md:grid-cols-[1fr_1.4fr] gap-20 items-start">
          <div>
            <span className="text-[0.68rem] tracking-[0.28em] uppercase block mb-4" style={{ color: textMuted }}>{tx.booking.eyebrow}</span>
            <h2 className="font-display text-[clamp(3rem,5vw,5rem)] leading-[0.95] tracking-[0.02em]" style={{ color: textPrimary }}>
              {c.bookTitle}
              <em className="font-['Playfair_Display'] not-italic italic text-[0.7em] block mt-1" style={{ color: textMuted }}>{c.bookTitleEm}</em>
            </h2>
            <div className="w-7 h-[2px] my-8" style={{ backgroundColor: blue }} />
            <p className="text-[0.9rem] leading-[1.9]" style={{ color: textBody }}>{c.bookIntro}</p>
          </div>
