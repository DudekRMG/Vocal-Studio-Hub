...
export default function KidsVocals() {
  ...
  return (
    <VoiceWidgetProvider accentColor="#3b82f6" pageName={c.heroTag}>
      <SeoHead
        ...
        <div className="max-w-[1100px] mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex-shrink-0 flex flex-col gap-3 w-full md:w-auto">
            ...
            <a
              ...
              className="font-display text-[1.1rem] tracking-[0.15em] px-10 py-5 no-underline transition-all duration-200 whitespace-nowrap inline-flex items-center justify-center gap-3 group text-[#0f1016]"
