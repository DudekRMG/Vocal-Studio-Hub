  ...
  return (
    <>
        ...
        <div className="max-w-[1100px] mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-col items-center gap-3 flex-shrink-0">
            ...
            <a
              ...
              className="font-display text-[1.1rem] tracking-[0.15em] px-10 py-5 no-underline transition-all duration-200 whitespace-nowrap inline-flex items-center gap-3 group text-[#0f1016]"
      ...
      <section id="book-kids" className="border-t" style={{ backgroundColor: bgCardAlt, borderColor: "rgba(0,0,0,0.07)" }}>
        {/* Widget strip */}
        <div className="px-6 lg:px-12 pt-10 pb-4 border-b" style={{ borderColor: "rgba(0,0,0,0.06)" }}>
          <div className="max-w-[1100px] mx-auto flex flex-col sm:flex-row items-center sm:items-center gap-4">
            <span className="text-[0.65rem] tracking-[0.22em] uppercase shrink-0" style={{ color: "rgba(15,16,22,0.3)" }}>
              {lang === "ru" ? "Узнайте свой тип голоса:" : "Check your voice type first:"}
            </span>
            <VoiceRangeWidget accentColor="#3b82f6" pageName={c.heroTag} lightMode />
          </div>
        </div>
        ...
        <div className="pt-12 pb-6 px-6 lg:px-12 border-t" style={{ borderColor: "rgba(0,0,0,0.07)" }}>
          <div className="max-w-[1100px] mx-auto mb-6">
            <span className="text-[0.62rem] tracking-[0.28em] uppercase block mb-3" style={{ color: blue }}>{tx.booking.moreOptions}</span>
            <p className="text-[0.88rem] leading-relaxed" style={{ color: "rgba(15,16,22,0.45)" }}>{tx.booking.moreOptionsDesc}</p>
          </div>
        </div>
