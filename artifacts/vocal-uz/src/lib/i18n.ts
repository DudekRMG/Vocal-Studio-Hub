...
export const t = {
  ru: {
    ...
    voiceWidget: {
      ...
      holdLabel: "Удержите для записи",
      recording: "Запись...",
      reRecord: "Перезаписать",
      confirm: "Подтвердить и продолжить",
      confirmMobile: "продолжить",
      ...
      validationTitle: "Проверьте запись",
      validationErrors: {
        narrow: "Диапазон слишком узкий — менее 8 полутонов. Держите каждую ноту дольше и пойте в полный голос.",
        wide: "Диапазон необычно широкий — возможна ошибка записи. Проверьте микрофон и попробуйте снова.",
        reversed: "Нижняя нота оказалась выше верхней — сессии могли перепутаться. Попробуйте снова.",
        tooLow: "Определена очень низкая нота — возможен субгармонический шум или помеха микрофона. Попробуйте снова.",
      },
      validationRetry: "Записать снова",
      stepTessituraTitle: "Натуральная высота",
      holdInstructionTessitura: "Удерживайте кнопку и напевайте вполголоса — как будто поёте себе под нос, занимаясь чем-то другим. Не старайтесь взять определённую ноту, просто дайте голосу звучать там, где ему удобно.",
      tessituraDetectedLabel: "Центр голоса определён",
      tessituraAutoFinish: "Продолжайте напевать — запись завершится автоматически",
      stepSexTitle: "Ваш биологический пол",
      sexOptionMale: "Мужской",
      sexOptionFemale: "Женский",
      qualifierMedium: "Вероятно",
      qualifierLow: "Возможно",
      qualifierLowFootnote: "Педагог уточнит тип голоса на занятии.",
      ...
      rangeLabel: "Диапазон:",
      rangeOctaves: "окт.",
      disclaimer: "Ваш полный анализ — диапазон, точные верхняя и нижняя ноты и дополнительные объяснения — придёт вам в Telegram.",
      disclaimerFooter: "Это приблизительный результат на основе короткого образца. Преподаватель может провести полноценный анализ.",
  ...
  en: {
    ...
    voiceWidget: {
      ...
      confirmMobile: "Confirm & Continue",
      ...
      validationTitle: "Check Your Recording",
      validationErrors: {
        narrow: "Range too narrow — less than 8 semitones detected. Hold each note longer and sing at full voice.",
        wide: "Range unusually wide — possible recording error. Check your microphone and try again.",
        reversed: "Your low note was detected higher than your high note — sessions may have been swapped. Please try again.",
        tooLow: "Extremely low note detected — possible sub-harmonic or mic noise. Please try again.",
      },
      ...
      qualifierMedium: "Likely",
      qualifierLow: "Possibly",
      qualifierLowFootnote: "Your teacher will confirm the final voice type in your first lesson.",
      ...
      rangeLabel: "Range:",
      rangeOctaves: "oct.",
      disclaimer: "Your full analysis — including your range, the exact highest and lowest notes and additional explanations — will be sent to you in Telegram.",
      disclaimerFooter: "This is an approximate result based on a short sample. A teacher can give you a full assessment.",
