...
export const t = {
  ru: {
    ...
    voiceWidget: {
      ...
      rangeLabel: "Диапазон:",
      rangeOctaves: "окт.",
      disclaimer: "Это приблизительный результат на основе короткого образца. Преподаватель может провести полноценный анализ. Ваш диапазон, нижняя и верхняя ноты, а также объяснение придут вам в сообщении.",
  ...
  en: {
    ...
    voiceWidget: {
      ...
      rangeLabel: "Range:",
      rangeOctaves: "oct.",
      disclaimer: "This is an approximate result based on a short sample. A teacher can give you a full assessment. Your range, lowest and highest notes, and an explanation will be sent to you in the message.",
