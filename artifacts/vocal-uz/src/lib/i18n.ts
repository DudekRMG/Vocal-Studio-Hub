...
export const t = {
  ru: {
    ...
    voiceWidget: {
      ...
      rangeLabel: "Диапазон:",
      rangeOctaves: "окт.",
      disclaimer: "Полный анализ — включая точные верхнюю и нижнюю ноты — придёт вам в Telegram.",
  ...
  en: {
    ...
    voiceWidget: {
      ...
      rangeLabel: "Range:",
      rangeOctaves: "oct.",
      disclaimer: "Your full analysis — including exact highest and lowest notes — will be sent to you in Telegram.",
