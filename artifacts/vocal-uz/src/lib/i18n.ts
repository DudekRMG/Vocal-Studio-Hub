...
export const t = {
  ru: {
    ...
    booking: {
      ...
      moreOptionsDesc: "Хотите изучить другие направления? Вот что ещё доступно у нас.",
  ...
  en: {
    ...
    booking: {
      ...
      moreOptionsDesc: "Looking for a different style? Here's everything else we offer.",
