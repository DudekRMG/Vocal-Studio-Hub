...
export const t = {
  ru: {
    ...
    voiceWidget: {
      ...
      rangeLabel: "Диапазон:",
      rangeOctaves: "окт.",
      disclaimer: "Ваш полный анализ — диапазон, точные верхняя и нижняя ноты и дополнительные объяснения — придёт вам в Telegram или SMS.",
      ...
      formSubtitle: "Отправим отчёт о вашем диапазоне и персональное предложение!",
      namePlaceholder: "Ваше имя",
  ...
  en: {
    ...
    voiceWidget: {
      ...
      rangeLabel: "Range:",
      rangeOctaves: "oct.",
      disclaimer: "Your full analysis — including your range, the exact highest and lowest notes and additional explanations — will be sent to you in Telegram or SMS.",
      ...
      formSubtitle: "We'll send your full vocal range report and a personalised offer!",
      namePlaceholder: "Your name",
